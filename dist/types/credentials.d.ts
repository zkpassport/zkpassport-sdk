...
export type IDCredentialValue<T extends IDCredential> = T extends 'nationality' | 'issuing_country' ? CountryName | Alpha2Code | Alpha3Code : T extends 'gender' ? 'male' | 'female' : T extends 'document_type' ? 'passport' | 'id_card' | 'residence_permit' | 'other' : T extends NumericalIDCredential ? number | Date : string;
